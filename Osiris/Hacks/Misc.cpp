...
void Misc::showKeybinds() noexcept
{
    ...
    ImGui::Begin("##KEY", NULL, ImGuiWindowFlags_::ImGuiWindowFlags_NoScrollWithMouse | ImGuiWindowFlags_::ImGuiWindowFlags_NoDecoration | ImGuiWindowFlags_::ImGuiWindowFlags_NoBackground);
    {
        ...
        auto bg_clrkey =
            ImColor(0, 0, 0, 150),
            line_clrkey = ImColor(127, 0, 0, 255),
            text_clrkey = ImColor(255, 255, 255, 255),
            glow_clr_firstkey = ImColor(127, 0, 0, 125),
            glow_clr_secondkey = ImColor(127, 0, 0, 0);
...
void Misc::watermark() noexcept
{
    ...
    std::string cheatname, username, build;
    ...
    ImGui::Begin("##WIM", NULL, ImGuiWindowFlags_::ImGuiWindowFlags_NoScrollWithMouse | ImGuiWindowFlags_::ImGuiWindowFlags_NoDecoration | ImGuiWindowFlags_::ImGuiWindowFlags_NoBackground);
    {
        ...
        auto bg_clr =
            ImColor(0, 0, 0, 150),
            line_clr = ImColor(127, 0, 0, 255),
            text_clr = ImColor(255, 255, 255, 255),
            glow_clr_first = ImColor(127, 0, 0, 125),
            glow_clr_second = ImColor(127, 0, 0, 0);
